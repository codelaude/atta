...
> **Note:** Tech-specific patterns (Vue, React, Django, etc.) belong in `.atta/team/patterns/[tech]-patterns.md`
...
**Pattern files** (`.atta/team/patterns/[tech]-patterns.md`) contain:
