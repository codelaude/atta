...
assert_contains ".claude/skills/collaborate/SKILL.md" "agent-learning.json" "collaborate skill reads learning profiles"
assert_contains ".claude/agents/librarian.md" "agentId" "librarian captures agentId in corrections"
assert_contains ".claude/skills/review/SKILL.md" "agentId" "review skill passes agentId"
assert_contains ".claude/skills/collaborate/SKILL.md" "agentId" "collaborate skill passes agentId"

echo "==> Validating learning dashboard (Track 7)"
assert_contains ".claude/skills/patterns/SKILL.md" "Dashboard Subcommand" "patterns skill has dashboard subcommand"
assert_contains ".claude/skills/patterns/SKILL.md" "Correction Velocity" "dashboard shows velocity trends"
assert_contains ".claude/skills/patterns/SKILL.md" "Agent Trends" "dashboard shows agent trends"
