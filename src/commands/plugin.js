...
function generateToolReadme(toolName, version, skills, { installCmd, prefix, renames }) {
  ...
  return [
    ...
    '## Links',
    '',
    '- [Documentation](https://github.com/codelaude/atta-dev)',
...
function generatePluginReadme(version, skills) {
  ...
  return [
    ...
    '2. Run `/atta:atta` to detect your tech stack and generate project-specific agents',
    '3. Run `/atta:tutorial` for a 5-minute interactive walkthrough',
    '4. Run `/atta:review` to review your code',
    '',
    '## Agents',
    '',
